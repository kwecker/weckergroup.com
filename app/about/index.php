			...
			<section id="bios" class="container">
				...
				<div class="row">
					<div class="six columns team__member group">
						...
						<div>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam quis eos repudiandae beatae, laborum facere vero pariatur aut quam molestiae deleniti voluptas possimus suscipit, nemo natus voluptatem fugiat, molestias dicta?
							</p>
						</div>
					</div>
					<div class="six columns team__member group">
				...
				<div class="row">
					...
					<div class="six columns team__member group">
						...
						<div>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. A maiores eaque, commodi enim quasi. Dolorum similique voluptate tempore enim, iure id suscipit aliquam ex quibusdam quos. Nostrum expedita accusamus nesciunt.
							</p>
						</div>
					</div>
				</div>
